    ...
    <div class="min-h-screen w-full flex items-center justify-center bg-blue-950 relative overflow-hidden font-sans">
        ...
        <div
            ...
            <div v-if="emailSent" class="text-center py-8">
                ...
                <router-link to="/login" class="text-indigo-400 font-bold hover:text-indigo-300">Ir al
                    Login</router-link>
            </div>
            ...
            <div v-else>
                <div class="text-center mb-8">
                    <h2 class="text-6xl md:text-7xl font-bold font-league text-white mb-2">Resetar contraseña</h2>
