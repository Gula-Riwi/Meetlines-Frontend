            ...
            <div class="flex-1 overflow-y-auto p-4 md:p-8 z-10 relative pb-20 md:pb-8">
                ...
                <div class="max-w-5xl mx-auto">
                    <div class="mb-6 md:mb-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                        <div>
                            <h1 class="text-2xl md:text-4xl tracking-wide font-league font-bold mb-1 md:mb-2">Configuración</h1>
                            <p class="text-sm md:text-base text-gray-400">Administra los detalles y servicios de tu negocio.</p>
                        </div>
                    </div>
                    ...
                    <div v-if="activeTab === 'general'" class="animate-fade-in-up space-y-6">
                        <div class="bg-gray-900 border border-white/10 rounded-2xl p-4 md:p-6">
                            ...
                            <!-- Dropzone -->
                            <div class="border-2 border-dashed border-gray-700 rounded-xl p-6 md:p-8 flex flex-col items-center justify-center text-center hover:border-indigo-500/50 hover:bg-white/5 transition-all cursor-pointer relative">
                                <input type="file" @change="handleFileUpload" accept="image/*"
                                    class="absolute inset-0 opacity-0 cursor-pointer" :disabled="isUploading">
                                
                                <div v-if="isUploading" class="flex flex-col items-center">
                                    <div class="animate-spin h-8 w-8 border-4 border-indigo-500 border-t-transparent rounded-full mb-2"></div>
                                    <span class="text-sm text-indigo-400">Subiendo...</span>
                                </div>
                                <div v-else class="flex flex-col items-center">
                                    <font-awesome-icon :icon="['fas', 'images']" class="text-3xl md:text-4xl text-gray-500 mb-3" />
                                    <span class="font-bold text-gray-300 text-sm md:text-base">Toca para subir imagen</span>
                        ...
                        <div class="bg-gray-900 border border-white/10 rounded-2xl p-4 md:p-6">
                            <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
                                <div>
                                    ...
                                    <p class="text-sm text-gray-400">Define los servicios que tus clientes pueden agendar.</p>
                                </div>
                                ...
                                <div v-for="(service, index) in services" :key="index"
                                    ...
                                    <div class="flex-1 space-y-3 w-full">
                                        ...
                                        <div class="flex gap-4">
                                            <div class="flex items-center gap-2 bg-gray-800/50 p-2 rounded-lg border border-white/5">
                                            ...
                                            <div class="flex items-center gap-2 bg-gray-800/50 p-2 rounded-lg border border-white/5">
                                                ...
                                                <input type="number" v-model="service.duration" placeholder="60"
                            ...
                            <div class="mt-6 flex justify-end sticky bottom-0 bg-gray-900 pt-4 pb-2 md:static md:bg-transparent md:p-0">
                    ...
                    <div v-if="activeTab === 'integrations'" class="animate-fade-in-up space-y-6">
                        ...
                        <div class="bg-gray-900 border border-white/10 rounded-2xl p-4 md:p-6">
                            <div class="flex items-center gap-3 mb-6">
                                <div class="w-10 h-10 bg-green-500/10 rounded-lg flex items-center justify-center text-green-500 text-xl">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                                <div class="space-y-1">
                                    ...
                                    <input type="text" v-model="whatsappConfig.whatsappVerifyToken" placeholder="Token de verificación"
                                ...
                                <div class="space-y-1">
                                    ...
                                    <input type="text" v-model="whatsappConfig.whatsappPhoneNumberId" placeholder="ID del número de teléfono"
                                        class="w-full bg-gray-950 border border-gray-700 rounded-lg px-4 py-2 text-white focus:border-green-500 focus:outline-none transition-colors text-sm">
                                </div>
                                <div class="space-y-1 md:col-span-2">
                                    <label class="text-xs text-gray-500 uppercase font-bold">Access Token</label>
                                    <input type="password" v-model="whatsappConfig.whatsappAccessToken" placeholder="Token de acceso de Meta"
                                        class="w-full bg-gray-950 border border-gray-700 rounded-lg px-4 py-2 text-white focus:border-green-500 focus:outline-none transition-colors text-sm">
                                </div>
                            </div>
                        ...
                        <div class="bg-gray-900 border border-white/10 rounded-2xl p-4 md:p-6">
                            <div class="flex items-center gap-3 mb-6">
                                <div class="w-10 h-10 bg-blue-500/10 rounded-lg flex items-center justify-center text-blue-400 text-xl">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                                ...
                                <div class="space-y-1 md:col-span-2">
                                    ...
                                    <input type="password" v-model="telegramConfig.botToken" placeholder="Ej: 123456:ABC-DEF1234ghIkl-zyx57W2v1u123ew11"
...
const handleFileUpload = async (event) => {
    ...
    try {
        ...
        reader.onload = (e) => {
            uploadedPhotos.value.push({ url: e.target.result });
        };
