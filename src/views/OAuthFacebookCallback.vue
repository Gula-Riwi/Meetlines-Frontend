<template>
  <div class="min-h-screen w-full flex items-center justify-center bg-blue-950">
    <div class="text-center">
      ...
      <h2 class="text-white text-2xl font-bold">Autenticando con Facebook...</h2>
...
onMounted(async () => {
  try {
    ...
    const response = await authService.facebookOAuthExchange({ code, redirectUri: `${window.location.origin}/auth/facebook/callback` });
